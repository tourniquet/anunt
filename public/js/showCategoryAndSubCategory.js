...
var changeCategoryName = function() {
	var category = document.getElementById('show-category').innerHTML;
	var subCategory = document.getElementById('show-sub-category').innerHTML;
	
	var changeCategory = document.getElementById('show-category');
	var changeSubCategory = document.getElementById('show-sub-category');
